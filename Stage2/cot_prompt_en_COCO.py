...
<question> represents the question to be answered, <sentiment>, <semantic>, and <style> are derived from the latest analyses of three experts, each from a different perspective, and <previous reasoning> contains your prior reasoning. Your task is to continue from the current 'Verification' step. Upon review, your previous reasoning and Final Conclusion appear false. Proceed to refine the reasoning using **backtracking** to revisit earlier points of reasoning and construct a new Final Conclusion.
...
<question> represents the question to be answered, <sentiment>, <semantic>, and <style> are derived from the latest analyses of three experts, each from a different perspective, and <previous reasoning> contains your prior reasoning. Your task is to continue from the current 'Verification' step. Upon review, your previous reasoning and Final Conclusion appear false. Proceed to refine the reasoning by exploring new approaches to solving this problem and construct a new Final Conclusion.
...
<question> represents the question to be answered, <sentiment>, <semantic>, and <style> are derived from the latest analyses of three experts, each from a different perspective, and <previous reasoning> contains your prior reasoning. Your task is to continue from the current 'Verification' step. Upon review, your previous reasoning and Final Conclusion appear false. Proceed to refine the reasoning by conducting a thorough **validation** process to ensure validity and construct a new Final Conclusion.
...
<question> represents the question to be answered, <sentiment>, <semantic>, and <style> are derived from the latest analyses of three experts, each from a different perspective, and <previous reasoning> contains your prior reasoning. Your task is to continue from the current 'Verification' step. Upon review, your previous reasoning and Final Conclusion appear false. Proceed to refine the reasoning by making precise **corrections** to address prior flaws and construct a new Final Conclusion.
